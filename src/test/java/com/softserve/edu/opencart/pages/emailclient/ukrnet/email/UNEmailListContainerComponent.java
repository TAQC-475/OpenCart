...
import com.softserve.edu.opencart.pages.emailclient.metaua.email.EmailListItemComponent;
import com.softserve.edu.opencart.pages.emailclient.metaua.email.EmailPage;
...
public class UNEmailListContainerComponent {
    private List<UNEmailListItemComponent> emailListItemComponents;
    private WebDriver driver;

    private final String XPATH_EMAIL_LIST_LOCATOR = "//table[contains(@class, 'noselect')]//tr[contains(@class, 'unread')]";
    ...
    public UNEmailListContainerComponent(WebDriver driver){
        this.driver = driver;
        initElements();
    ...
    private void initElements(){
        ...
        for(WebElement currentEmailListItem : driver.findElements(By.xpath(XPATH_EMAIL_LIST_LOCATOR))){
            emailListItemComponents.add(new UNEmailListItemComponent(currentEmailListItem));
        }
    }

    public List<UNEmailListItemComponent> getEmailListItemComponents() {
        return emailListItemComponents;
    }


    private boolean isMessageMatches(UNEmailListItemComponent emailComponent){
    ...
    public UNEmailListItemComponent findResetPasswordEmail() throws RuntimeException{
        for(UNEmailListItemComponent component : getEmailListItemComponents()){
